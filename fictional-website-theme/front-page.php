...
<div class="full-width-split group">
  <div class="full-width-split__one">
    <div class="full-width-split__inner">
      ...
      $events_list_args = array(
        'posts_per_page' => 2,
        'post_type' => 'event'
      );
      $homepageEvents = new WP_Query($events_list_args);
      ...
      <?php while ($homepageEvents->have_posts()) : $homepageEvents->the_post(); ?>
        ...
        <div class="event-summary">
          ...
          <div class="event-summary__content">
            <h5 class="event-summary__title headline headline--tiny"><a href="<? the_permalink(); ?>"><?php the_title(); ?></a></h5>
            <p><?php
                if (has_excerpt()) {
  ...
  <div class="full-width-split__two">
    <div class="full-width-split__inner">
      ...
      $homepagePosts = new WP_Query($posts_list_args);
      ?>
